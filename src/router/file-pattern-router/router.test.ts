...
import { FilePatternRouter } from './router'

describe('Basic Usage', () => {
  const router = new FilePatternRouter<string>()
...
describe('Complex', () => {
  let router: FilePatternRouter<string>
  beforeEach(() => {
    router = new FilePatternRouter<string>()
  })
...
describe.skip('Check for duplicate parameter names', () => {
  it('self', () => {
    const router = new FilePatternRouter<string>()
...
describe.skip('UnsupportedPathError', () => {
  describe('Ambiguous', () => {
    const router = new FilePatternRouter<string>()
...
describe('long prefix, then star', () => {
  ...
  describe.skip('Including slashes', () => {
    const router = new FilePatternRouter<string>()

    router.add('GET', '/js/:filename{[a-z0-9/]+.js}', 'any file')

    // XXX This route can not be added with `:label` to FilePatternRouter. This is ambiguous.
