    ...
    skip: [
      {
        ...
        tests: [
          ...
          'Params after a middle wildcard > GET /acme/123/users',
          'Params after a middle wildcard > GET /acme/123/users in reverse registration order',
          'Params after a middle wildcard > POST /acme/123/users with ALL middleware',
          'Params after a middle wildcard > GET /org/acme/123/users with different param names',
          'Params after a middle wildcard > GET /eu/acme/123/users with consecutive wildcards',
          'Params after a middle wildcard > GET /acme/123/users with a regexp param',
          'Overlapping wildcard middleware > GET /acme/admin/users',
          'Overlapping wildcard middleware > GET /acme/admin/users in reverse registration order',
          'Overlapping wildcard middleware > GET /acme/admin/users with a shorter label middleware',
          'Overlapping wildcard middleware > GET /acme/admin/users with a middle wildcard route',
          'Default pattern in a route > GET /acme/admin/users with a label middleware',
          'Default pattern in a route > GET /acme does not run a longer middleware',
          'Default pattern in a route > GET /acme/admin/users with the default pattern followed by a label',
          'Params on a static route > GET /a/foo',
          'Params on a static route > GET /a/foo in reverse registration order',
          'Params on a static route > GET and POST /a/foo with ALL middleware',
          'Params on a static route > GET /a/b/foo with overlapping middleware',
