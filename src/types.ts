...
export type ValidPath<P extends string> = string extends P
  ? P
  : P extends `${string}**${string}`
    ? never
    : P

export type ValidPaths<Ps extends readonly string[]> = {
  [K in keyof Ps]: Ps[K] extends string ? ValidPath<Ps[K]> : Ps[K]
}
