...
declare namespace Deno {
   ...
   *      })();
   */
  export function seek(rid: number, offset: number, whence: SeekMode): Promise<void>
  /** Close the file ID. */
  export function close(rid: number): void
  /** The Deno abstraction for reading and writing files. */
  export class File implements Reader, SyncReader, Writer, SyncWriter, Seeker, SyncSeeker, Closer {
    readonly rid: number
   ...
   */
  export function utimeSync(filename: string, atime: number | Date, mtime: number | Date): void
   ...
   */
  export function utime(filename: string, atime: number | Date, mtime: number | Date): Promise<void>
   ...
   */
  export type PermissionName = 'run' | 'read' | 'write' | 'net' | 'env' | 'hrtime'
...
declare namespace customEvent {
  ...
  export class CustomEventInit extends event.EventInit implements domTypes.CustomEventInit {
    detail: any
    constructor({ bubbles, cancelable, composed, detail }: domTypes.CustomEventInit)
  }
...
declare namespace WebAssembly {
  ...
  function compileStreaming(source: Promise<domTypes.Response>): Promise<Module>
