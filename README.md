...
```plain
hono x 723,296 ops/sec ±5.97% (72 runs sampled)
itty-router x 160,811 ops/sec ±3.35% (91 runs sampled)
sunder x 302,867 ops/sec ±5.02% (81 runs sampled)
worktop x 199,306 ops/sec ±5.12% (78 runs sampled)
Fastest is hono
✨  Done in 50.19s.
```
